<div class="panel sales-info-panel">
    ...
    <div class="sales-info-container">
        <div class="sales-info-box">
            ...
            <small>{l s='Yesterday' mod='bpm_salesinfo'}: {if $ventasAyer}{$ventasAyer} €{else}{l s='No data yet' mod='bpm_salesinfo'}{/if}</small>
        ...
        <div class="sales-info-box">
            ...
            <small>{l s='Last week' mod='bpm_salesinfo'}: {if $ventasSemanaPasada}{$ventasSemanaPasada} €{else}{l s='No data yet' mod='bpm_salesinfo'}{/if}</small>
        ...
        <div class="sales-info-box">
            ...
            <small>{l s='Last month' mod='bpm_salesinfo'}: {if $ventasMesPasado}{$ventasMesPasado} €{else}{l s='No data yet' mod='bpm_salesinfo'}{/if}</small>
        ...
        <div class="sales-info-box">
            ...
            <small>{l s='Last year' mod='bpm_salesinfo'}: {if $ventasYearPasado}{$ventasYearPasado} €{else}{l s='No data yet' mod='bpm_salesinfo'}{/if}</small>
    ...
    <div class="sales-info-container">
        <div class="sales-info-box">
            ...
            <small>{l s='Yesterday' mod='bpm_salesinfo'}: {if $carritosAyer}{$carritosAyer}{else}{l s='No data yet' mod='bpm_salesinfo'}{/if}</small>
        ...
        <div class="sales-info-box">
            ...
            <small>{l s='Last week' mod='bpm_salesinfo'}: {if $carritosSemanaPasada}{$carritosSemanaPasada}{else}{l s='No data yet' mod='bpm_salesinfo'}{/if}</small>
        ...
        <div class="sales-info-box">
            ...
            <small>{l s='Last month' mod='bpm_salesinfo'}: {if $carritosMesPasado}{$carritosMesPasado}{else}{l s='No data yet' mod='bpm_salesinfo'}{/if}</small>
        ...
        <div class="sales-info-box">
            ...
            <small>{l s='Last year' mod='bpm_salesinfo'}: {if $carritosYearPasado}{$carritosYearPasado}{else}{l s='No data yet' mod='bpm_salesinfo'}{/if}</small>
